                            ...
                            <form id="formProfil">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="inputPhone" class="form-control" value="" placeholder="08xxxx">
                                    </div>
        ...
        (function () {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                document.getElementById("formProfil").addEventListener("submit", async function (event) {
                    ...
                    const phoneBaru = document.getElementById("inputPhone").value.trim();
                    ...
                    try {
                        ...
                        formData.append('name', namaBaru);
                        formData.append('phone', phoneBaru);
                        if (fileGambarBaruFile) {
                            formData.append('avatar', fileGambarBaruFile);
                        }
                        ...
                        if (result.data.avatar_url) {
                            localStorage.setItem("avatarUrl", result.data.avatar_url);
                        }

                        if (fileGambarBaru && !result.data.avatar_url) {
