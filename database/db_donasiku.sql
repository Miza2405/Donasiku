...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2026 at 04:49 PM
...
--
-- Table structure for table `fund_distributions`
--
...
--
-- Dumping data for table `fund_distributions`
--

INSERT INTO `fund_distributions` (`id`, `program_id`, `beneficiary`, `amount`, `proof_image`, `distributed_at`, `created_by`, `created_at`) VALUES
(1, 13, 'Panti asuhan', 1500000.00, 'img/penyaluran_1780319698_b105fac0.gif', '2026-06-10', 1, '2026-06-01 13:14:58'),
(2, 1, 'Masjid', 15000000.00, 'img/penyaluran_1780319790_2ea964c3.webp', '2026-05-04', 1, '2026-06-01 13:16:30');
...
(2, 'Bantuan Medis & Kemanusiaan Darurat', 'darurat', NULL, 100000000.00, 54695750.00, NULL, 'active', NULL, '2026-04-21 06:13:17'),
(3, 'Santunan Pendidikan Anak Yatim', 'yatim', NULL, 50000000.00, 15000000.00, NULL, 'active', NULL, '2026-04-21 06:13:17'),
(4, 'Indonesia Darurat Bencana: Longsor & Banjir', 'darurat', 'Bantuan darurat banjir dan longsor di Malalak Timur Agam.', 100000000.00, 36307837.00, 'https://akcdn.detik.net.id/visual/2025/11/27/longsor-di-malalak-timur-agam-1764227249858_169.jpeg?w=1200', 'active', '2026-08-31', '2026-06-01 12:05:08'),
(5, 'Berbagi Paket Sembako Untuk Keluarga Dhuafa', 'pangan', 'Distribusi sembako untuk keluarga dhuafa yang terdampak pandemi dan ekonomi sulit.', 30000000.00, 18500000.00, 'https://www.lead.co.id/wp-content/uploads/2020/04/IMG-20200404-WA0187.jpg', 'active', '2026-09-30', '2026-06-01 12:05:08'),
...
(8, 'Santunan Anak Yatim Pelosok Negeri', 'yatim', 'Bantuan pendidikan dan kebutuhan dasar untuk anak yatim di daerah pelosok.', 50000000.00, 12400000.00, 'img/program_1780320557_4aead54d.webp', 'active', '2026-10-31', '2026-06-01 12:05:08'),
...
(10, 'Pembangunan Masjid Pelosok Desa', 'jariyah', 'Pembangunan masjid baru untuk mendukung ibadah dan kegiatan sosial masyarakat desa.', 500000000.00, 250000000.00, 'img/program_1780320564_70e54d01.webp', 'active', '2027-01-31', '2026-06-01 12:05:08'),
...
(13, 'when yah', 'jariyah', '0', 241414214.00, 0.00, 'img/program_1780315632_5837db6a.webp', 'active', '2026-06-18', '2026-06-01 12:07:12');
...
(2, 'TRX-002', 3, 2, 135000.00, 'QRIS', 'Semoga saudara kita diberi ketabahan.', 'success', 1, '2026-04-21 06:13:17'),
(3, 'TRX-20260601141439-6', 10, 4, 500000.00, 'BCA Virtual Account', 'semoga berkah', 'pending', NULL, '2026-06-01 12:14:39'),
(4, 'TRX-20260601142202-9', 10, 4, 1231313.00, 'BCA Virtual Account', 'awewaea', 'success', 1, '2026-06-01 12:22:02'),
(5, 'TRX-20260601162256-2', 9, 4, 250000.00, 'Gopay', '', 'pending', NULL, '2026-06-01 14:22:56');
...
(1, 'Admin DonasiKu', 'admin@gmail.com', '12345', 'admin', 'super_admin', NULL, NULL, '2026-04-21 06:13:17'),
...
(9, 'wengki', 'wengki@gmail.com', '12345', 'user', '', NULL, NULL, '2026-04-21 06:13:17'),
(10, 'yoni', 'yoni@gmail.com', '12345', 'user', '', NULL, NULL, '2026-04-21 06:13:17');
...
--
-- Indexes for table `fund_distributions`
--
...
--
-- AUTO_INCREMENT for table `fund_distributions`
--
ALTER TABLE `fund_distributions`
...
--
-- Constraints for table `fund_distributions`
--
ALTER TABLE `fund_distributions`
